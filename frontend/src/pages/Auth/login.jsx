                                ...
                                <div>
                                    ...
                                    <div className="relative flex items-center">
                                        <input
                                            ...
                                            className={`w-full rounded-lg border bg-zinc-900 px-4 py-3 pr-11 text-sm text-[#F9F8F5] placeholder:text-zinc-500 outline-none transition duration-200 ${errors.password
                                                    ? "border-red-500 focus:border-red-500"
                                                    : "border-zinc-800 focus:border-[#F9F8F5]"
                                                }`}
                                        />
